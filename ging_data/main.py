...
if __name__ == '__main__':
    logfile = open("leo_800A_run_5.log")
    #cansend can0
...
# 
    ...
    plt.plot(bms_times, pack_current, label='Pack current',color = 'pink')
    plt.axvline(217.4, color = 'r')
    ...
    plt.plot(mc281_times, statusword, label='MC Temp', color='orange')
